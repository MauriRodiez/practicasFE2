...
// 3- Si el usuario confirma debemos aplicar la clase "dark" al "sitio", si cancela debe 
// quedar en modo claro.
// 4- A su vez, si está en modo onsecuritypolicyviolation, el texto del boton debe decir 
// "Cambiar a modo claro 🌞". De lo contrario, si está en modo claro debeb decir "Cambiar
//  a modo oscuro 🌛"
function elegirTema() {
    let confirmarcambio = confirm("Quiere cambiar el tema?");
    if (confirmarcambio) {
        sitio.classList.toggle("dark");
    } else {
        sitio.classList.remove("dark");
    }
    //console.log(confirmarcambio);
}
elegirTema();
